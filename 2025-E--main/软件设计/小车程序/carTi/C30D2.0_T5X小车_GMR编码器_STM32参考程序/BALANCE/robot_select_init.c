...
void Robot_Select(void)
{
  ...
  if(Car_Mode>7)Car_Mode=7;
	...
	switch(Car_Mode)
	{
		case Mec_Car:       Robot_Init(MEC_wheelspacing,         MEC_axlespacing,          0,                     HALL_30F, Photoelectric_500, Mecanum_75);            break; //R550麦克纳姆轮小车
		case Omni_Car:      Robot_Init(0,                        0,                        Omni_Turn_Radiaus_109, HALL_30F, Photoelectric_500, FullDirecion_60);       break; //R550全向轮小车
		case Akm_Car:       Robot_Init(Akm_wheelspacing,         Akm_axlespacing,          0,                     HALL_30F, Photoelectric_500, Black_WheelDiameter);   break; //R550阿克曼小车
		
		case Diff_Car:      Robot_Init(Diff_wheelSpacing,        0,                        0,                     HALL_22_5F, 	Photoelectric_500, Black_WheelDiameter);   break; //T5X两轮差速小车--减速比22.5
		case FourWheel_Car: Robot_Init(Four_Mortor_wheelSpacing, Four_Mortor__axlespacing, 0,                     HALL_22_5F, 	Photoelectric_500, Black_WheelDiameter);   break; //T5X四驱车 --减速比22.5
		case Tank_Car:      Robot_Init(Tank_wheelSpacing,        0,                        0,                     HALL_30F, Photoelectric_500, Tank_WheelDiameter);    break; //R550履带车
