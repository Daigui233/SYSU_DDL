...
export MULTITASK_ROAD_MAX_COMPONENTS=2
export MULTITASK_ROAD_SECOND_COMPONENT_MIN_AREA_RATIO=0.005
export MULTITASK_ROAD_SECOND_COMPONENT_MIN_LARGEST_RATIO=0.15
export MULTITASK_ROAD_EDGE_SMOOTH_KERNEL=5
