...
export MULTITASK_HUMAN_THRESHOLD=0.40
export MULTITASK_CAR_THRESHOLD=0.40
...
export VISION_CONTROL_HUMAN_MIN_SCORE=0.40
export VISION_CONTROL_CAR_MIN_SCORE=0.40
export VISION_CONTROL_HUMAN_SPEED_HOLD_S=0.5
export VISION_CONTROL_CAR_AVOID_SPEED=0.35
...
export VISION_CONTROL_HUMAN_STOP_LINE_OFFSET_PX_480=15
