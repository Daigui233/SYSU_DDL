...
TASK_TO_TC264_STATE = {
    ...
    TaskState.AVOID_STONE.value: Tc264State.STATE_AVOID_STONE,
    TaskState.COLLECT_GOLD.value: Tc264State.STATE_COLLECT_GOLD,
    TaskState.TRAFFIC_LIGHT_STOP.value: Tc264State.STATE_TRAFFIC_LIGHT_STOP,
    TaskState.ENDSIGN_STOP.value: Tc264State.STATE_ENDSIGN_STOP,
